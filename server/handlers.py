...
from config import (
    SERVER_IGNORE_PROBABILITY,
    SERVER_RESPONSE_MIN_DELAY,
    SERVER_RESPONSE_MAX_DELAY,
)
...
class ServerHandler:
    ...
    async def handle_ping(self, message: str, client_id: int, writer: asyncio.StreamWriter, request_time: datetime):
